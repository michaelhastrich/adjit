...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Dit zijn de widgets in de Footer', 'html5blank'),
        'id' => 'widget-area-1',
    ...
    register_sidebar(array(
        ...
        'description' => __('Dit zijn de widgets in de Sidebar', 'html5blank'),
        'id' => 'widget-area-2',
...
//Fixing Gravity Form tab indexes
